...
def load_train_data():
    ...
    x_train = np.load('/content/my_tut_drive/kaggle-acoustic-scene-2018/X_train.npy')
...
def load_test_data():
    x_test = np.load('/content/my_tut_drive/kaggle-acoustic-scene-2018/X_test.npy')
    #Compute the average over the frequency axis=1
...
def load_train_labels():
    labels = []
    with open ('/content/my_tut_drive/kaggle-acoustic-scene-2018/y_train.csv', 'r') as fp:
        for line in fp:
            # Skip the first line:
...
def load_cross_val(X_train, y_train):
    ...
    test_data = []
    test_labels = []
    with open ('/content/my_tut_drive/kaggle-acoustic-scene-2018/crossvalidation_train.csv', 'r') as fp:
        for line in fp:
            # Skip the first line:
